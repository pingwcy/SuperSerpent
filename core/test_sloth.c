...
static int test_whirl_sloth() {
    ...
    const uint8_t answer[BLOCK_SIZE_WHIRLPOOL_SLOTH] = {
...
static int test_spt_sloth() {
    ...
    const uint8_t plain[BLOCK_SIZE_SLOTH] = {
    ...
    const uint8_t answer[BLOCK_SIZE_SLOTH] = {
...
static int test_pbkdf2_sloth() {
    ...
    const char password[] = "Lappeenranta, Finland.";
    uint8_t master_key[KEY_SIZE_SLOTH + HMAC_WHIRLPOOL_KEY_SIZE_SLOTH];
    const uint8_t answer[KEY_SIZE_SLOTH + HMAC_WHIRLPOOL_KEY_SIZE_SLOTH] = {
...
static int test_xts_sloth(){
    const int sector = 417092917;
    const uint8_t key1[KEY_SIZE_SLOTH] = {
    ...
    const uint8_t key2[KEY_SIZE_SLOTH] = {
